# 爬虫
   ...
   * 修改配置文件
     ...
     ![config.gif](https://github.com/zhuzhixu/cloud_development_answers/blob/master/pic/config.gif)

     **修改该config文件下的需要配置的配置文件\(修改ip地址,使用hbase虚拟机的ip地址,可通过在虚拟机中ip addr指令来查询\)**
